...
@compat function jlconvert(T::Union{Type{String}, Type{String}}, ::JldFile, ptr::Ptr)
...
if VERSION < v"0.4.0-dev+3864"
    jlconvert(::Type{BigInt}, file::JldFile, ptr::Ptr) =
        Base.parseint_nocheck(BigInt, jlconvert(String, file, ptr), 62)
else
    jlconvert(::Type{BigInt}, file::JldFile, ptr::Ptr) =
...
jlconvert{T<:Type}(::Type{T}, file::JldFile, ptr::Ptr) = julia_type(jlconvert(String, file, ptr))
